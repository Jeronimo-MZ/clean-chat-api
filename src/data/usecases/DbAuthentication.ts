...
import { LoadUserByUsernameRepository, UpdateAccessTokenRepository } from "@/data/protocols/database";
...
export class DbAuthentication implements Authentication {
    ...
    async auth({ username, password }: Authentication.Input): Promise<Authentication.Output> {
        ...
        await this.updateAccessTokenRepository.updateAccessToken(user.id, token);
